...
import { Users, BookOpen, Star, Target, TrendingUp } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-stone-900 rounded-xl shadow-sm border border-stone-200 dark:border-stone-800 p-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-stone-900 dark:text-stone-100">12,489</p>
          </div>
        </div>
        <div className="bg-white dark:bg-stone-900 rounded-xl shadow-sm border border-stone-200 dark:border-stone-800 p-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-stone-900 dark:text-stone-100">4,203</p>
          </div>
        </div>
        <div className="bg-white dark:bg-stone-900 rounded-xl shadow-sm border border-stone-200 dark:border-stone-800 p-6 flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-stone-500 dark:text-stone-400">Reviews</p>
            <p className="text-2xl font-bold text-stone-900 dark:text-stone-100">45.2k</p>
          </div>
        </div>
        <div className="bg-white dark:bg-stone-900 rounded-xl shadow-sm border border-stone-200 dark:border-stone-800 p-6 flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-stone-500 dark:text-stone-400">Active Daily</p>
            <p className="text-2xl font-bold text-stone-900 dark:text-stone-100">3,120</p>
          </div>
        </div>
      </div>
