          ...
          <div className="py-2 px-2">
            {user?.role === 'ADMIN' && (
              <Link
                ...
                className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 hover:bg-amber-100 dark:hover:bg-amber-900/40 transition-colors font-bold mb-1"
              >
    ...
    <>
      ...
      >
        <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-4">
          ...
          >
            <div className="w-8 h-8 rounded-lg flex items-center justify-center shadow-sm overflow-hidden border border-stone-200 dark:border-stone-700 group-hover:scale-105 transition-transform">
              <img src="/logo.jpg" alt="BookClub Logo" className="w-full h-full object-cover" />
            </div>
            <span className="font-serif font-bold text-[17px] tracking-tight text-stone-900 dark:text-white group-hover:text-amber-600 transition-colors">
              BookClub
            </span>
          </Link>
